  ...
  void loadSurveys() {
    surveys.value = [
      Survey(
        ...
        description:
            'Share your opinions on medical services, fitness, and wellness.',
        icon: Icons.favorite_outline,
        color: Colors.blue,
      ),
      Survey(
        title: 'Entertainment Survey',
        description: 'Express your views on movies, TV shows, and games.',
      ...
      Survey(
        title: 'Music Survey',
        description:
            'Tell us about your favourite genres, artists, and music apps.',
      ...
      Survey(
        ...
        description:
            'Participate in feedback about schools, online courses, and education platforms.',
      ...
      Survey(
        ...
        description:
            'Give your opinion on gadgets, apps and software tools you use daily.',
